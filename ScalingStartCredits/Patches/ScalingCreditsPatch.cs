...
namespace ScalingStartCredits.Patches
{
    ...
    internal class StartingCreditsPatch
    {
        ...
        private static ManualLogSource mls = BepInEx.Logging.Logger.CreateLogSource(ScalingStartCreditsMain.modGUID);
        ...
        {
            groupCreditIncreaseIncrement = ScalingStartCreditsMain.Instance.configCreditIncrement.Value;
            playerThreshold = ScalingStartCreditsMain.Instance.configPlayerCountThreshold.Value;
